                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="movie-meta">
                            ...
                            <li><strong>Durée : </strong> 98 min</li>
                            <li><strong>Sortie : </strong> 22 March 2013 (USA)</li>
                            <li><strong>Genre : </strong> Animation/Aventure/Comedie</li>
                        </ul>

                        <ul class="starring">
                            <li><strong>Réalisateur : </strong> Kirk de Mico (as Kirk DeMico). Chris Sanders</li>
                            <li><strong>Acteurs : </strong> Nicolas Cage, Ryan Reynolds, Emma Stone</li>
                        </ul>
                    </div>
                </div> <!-- .row -->
